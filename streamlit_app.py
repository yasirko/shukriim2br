...
st.write(" - اذا ظهرت رسالة خطأ فهذا نسبة للضغط علي المشغل حاول في وقت لاحق هذا التطبيق يعرض الأسهم التي تلبي شروط الاستراتيجية.")
...
condition_options = {
    '٣ شموع سلبية': '٣ شموع سلبية',
    '٤ شموع سلبية': '٤ شموع سلبية',
}
...
if st.button("فحص الاسهم"):
    if tickers:
        met_conditions = check_conditions(tickers, interval, selected_condition)
